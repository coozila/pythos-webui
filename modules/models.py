...
def llamacpp_HF_loader(model_name):
    ...
    for fname in [model_name, "coozila_llama-tokenizer", "llama-tokenizer"]:
        ...
        logger.error("Could not load the model because a tokenizer in transformers format was not found. Please download coozila/llama-tokenizer.")
        return None, None
...
def QuipSharp_loader(model_name):
    try:
        ...
        logger.error(
            ...
            "https://github.com/coozila/pythos-webui/pull/4803\n"
        )
        return None, None
